...
/**
 * A computational unit in a network. A {@link Node} receives a stream of messages to process.
 ...
 * with other  {@link Node} instances.
 * <p>
 * The semantics of {@link #onNext(T)}, {@link #onError(Throwable)}, and {@link #onComplete()} are
 * similar to {@link Flow.Subscriber}. There are, however, a few semantic differences. First, a
